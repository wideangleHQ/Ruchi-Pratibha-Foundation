...
export const ArchiveHero: React.FC<ArchiveHeroProps> = ({ onOpenSearch }) => {
  ...
  return (
    ...
    >
      ...
      {/* Hero Content — Bottom-left text / Bottom-right buttons */}
        ...
        <div className="max-w-[1500px] w-full mx-auto flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 lg:gap-12">
          ...
          <div className="flex flex-col items-start max-w-[70%] sm:max-w-full lg:max-w-[65%]">
            ...
            <motion.h1
              ...
              className="font-cormorant text-3xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-white mb-6 leading-[1.12]"
            >
