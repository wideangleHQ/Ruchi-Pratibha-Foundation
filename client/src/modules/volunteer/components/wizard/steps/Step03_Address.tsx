...
export const Step03_Address: React.FC = () => {
    ...
    <div className="flex flex-col h-full">
      <div className="mb-8">
        ...
        <p className="font-manrope text-gray-600 dark:text-gray-400">
          Where are you currently based? This helps us match you with local opportunities.
        </p>
      </div>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="flex flex-col gap-2">
              <label className="font-space text-xs uppercase tracking-widest text-gray-500 font-semibold">Country</label>
              <input
                required
                type="text"
            ...
            <div className="flex flex-col gap-2">
              <label className="font-space text-xs uppercase tracking-widest text-gray-500 font-semibold">State</label>
              <input
                required
                type="text"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="flex flex-col gap-2">
              <label className="font-space text-xs uppercase tracking-widest text-gray-500 font-semibold">District</label>
              <input
                required
                type="text"
            ...
            <div className="flex flex-col gap-2">
              <label className="font-space text-xs uppercase tracking-widest text-gray-500 font-semibold">City / Town</label>
              <input
                required
                type="text"
                value={formData.city}
          ...
          <div className="flex flex-col gap-2 sm:w-1/2 sm:pr-3">
            <label className="font-space text-xs uppercase tracking-widest text-gray-500 font-semibold">PIN Code</label>
            <input
              required
              type="text"
              value={formData.pin}
