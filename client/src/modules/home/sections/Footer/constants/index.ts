...
export const FOOTER_SECTIONS: FooterSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Odisha Memory Map', href: '/visual-archive#odisha-memory-map' },
      { label: 'Media Resources', href: '/visual-archive#media-resource' },
      { label: 'Share Your Memory', href: '/visual-archive#share-memory' },
    ],
  },
  {
    title: 'Get Involved',
...
export const CONTACT_INFO = {
  address: 'Ruchi Prativa Foundation, Institutional Estate, Cuttack - 753001, Odisha, India',
  phone: '+91 (0671) 234-5678',
  email: 'contact@ruchiprativafoundation.org',
