...
export const Timeline: React.FC = () => {
  ...
  return (
    <section
      id="timeline"
      className="py-20 sm:py-24 bg-institutional-light dark:bg-institutional-dark text-institutional-dark dark:text-institutional-light border-b border-institutional-dark/10 dark:border-white/10 overflow-hidden"
    >
