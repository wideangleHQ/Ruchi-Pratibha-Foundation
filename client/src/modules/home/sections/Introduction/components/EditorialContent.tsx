...
export const EditorialContent: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col justify-center max-w-xl xl:max-w-2xl mx-auto lg:mx-0 py-4 lg:py-0"
    >
      {/* Eyebrow badge */}
      ...
      {/* Main Title */}
      <h2 className="font-cormorant text-4xl sm:text-5xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-institutional-dark dark:text-white mb-6 lg:mb-8 leading-[1.12]">
        {EDITORIAL_CONTENT.heading}
      </h2>

      {/* Narrative Paragraphs */}
      <div className="space-y-4 lg:space-y-5 font-manrope text-base lg:text-lg text-institutional-mutedLight dark:text-gray-300 leading-relaxed lg:leading-relaxed mb-8 lg:mb-10">
